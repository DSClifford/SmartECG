...
public class DBDataSource {
    ...
    public boolean create(String recordID, int maxHR) {
    ...
    private void deleteRecord(int dbInsertIndex) {
        ...
        File fileToDelete = new File(basepath+"/ECGrecords/"+recIDtoDelete+".txt");
        fileToDelete.delete();
    ...
    public void printRecordList(String basepath) {
        File f = new File(basepath+"/ECGrecords");
        File file[] = f.listFiles();
        Log.d("PrintingRecordList",String.valueOf(file.length));

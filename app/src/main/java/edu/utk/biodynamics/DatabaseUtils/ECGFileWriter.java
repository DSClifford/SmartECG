...
public class ECGFileWriter {
    public static void newFile(short[] ecg_toAnalyze, String randomID, String basepath) {
        ...
        File folder = new File(basepath+"/ECGrecords");
        ...
        try {
            out = new PrintWriter(new FileOutputStream(basepath+"/ECGrecords/"+randomID+".txt"));
        ...
        File file = new File(basepath+"/ECGrecords");
